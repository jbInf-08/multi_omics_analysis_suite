...
class TestProjectEndpoints:
    ...
    def test_create_project(self, test_client, mock_project_data, auth_headers, mock_db_session, db_override):
...
class TestDatasetEndpoints:
    ...
    def test_create_dataset(self, test_client, mock_dataset_data, auth_headers, mock_db_session, db_override):
...
class TestAnalysisEndpoints:
    ...
    def test_create_analysis(
        self, test_client, mock_analysis_data, auth_headers, mock_db_session, db_override, auth_user_id
    ):
...
class TestPaginationAndFiltering:
    ...
    def test_filtering_by_status(self, test_client, auth_headers, mock_db_session, db_override):
        ...
        response = test_client.get(
            "/api/v1/analyses/?status_filter=completed",
            headers=auth_headers
        )
    ...
    def test_invalid_pagination(self, test_client, auth_headers, mock_db_session, db_override):
        ...
        response = test_client.get(
            "/api/v1/analyses/?page=-1&page_size=0",
            headers=auth_headers
        )
...
class TestErrorHandling:
    ...
    def test_method_not_allowed(self, test_client, auth_headers):
        ...
        response = test_client.patch(
            "/api/v1/analyses/",  # PATCH not allowed on list endpoint
            headers=auth_headers
        )
