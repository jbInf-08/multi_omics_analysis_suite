                            ...
                            dbc.Card(
                                [
                                    ...
                                    dbc.CardBody(
                                        [
                                            dbc.Progress(
                                                value=100, color="success", className="mb-2"
                                            ),
                                            html.Small(
                                                "API: Online", className="text-success d-block"
                                            ),
                                            html.Small(
                                                "Database: Connected",
                                            ...
                                            html.Small(
                                                "Workers: Running", className="text-success d-block"
                                            ),
                                        ]
                                    ),
                                ]
...
def create_transcriptomics_dashboard():
    ...
    pca_fig = create_pca_plot(
        DEMO_PCA_DATA, color_col="group", var_explained=[45.2, 23.1], title="Sample PCA"
    )
