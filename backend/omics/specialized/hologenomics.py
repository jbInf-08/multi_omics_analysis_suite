...
class HologenomicsModule(OmicsModuleBase):
    ...
    def get_available_pipelines(self) -> list[Pipeline]:
        return [
            Pipeline(
                name="holobiont",
                description="Holobiont analysis",
    ...
    def get_available_analyses(self) -> list[AnalysisDefinition]:
        return [
            AnalysisDefinition(
                name="host_microbe_correlation", description="Host-microbe correlation"
            ),
            AnalysisDefinition(name="coevolution", description="Host-microbe coevolution analysis"),
            AnalysisDefinition(
                name="metatranscriptomics", description="Combined metatranscriptomics"
            ),
        ]
