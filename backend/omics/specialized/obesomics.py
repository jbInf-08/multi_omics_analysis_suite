...
class ObesomicsModule(OmicsModuleBase):
    ...
    def description(self) -> str:
        return (
            "Obesity-related multi-omics analysis including adipose tissue and metabolic profiling"
        )
    ...
    def get_available_pipelines(self) -> list[Pipeline]:
        return [
            Pipeline(
                name="adipose_profiling",
                description="Adipose tissue profiling",
    ...
    def get_available_analyses(self) -> list[AnalysisDefinition]:
        return [
            ...
            AnalysisDefinition(
                name="insulin_resistance", description="Insulin resistance profiling"
            ),
        ]
