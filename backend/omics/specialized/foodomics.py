...
class FoodomicsModule(OmicsModuleBase):
    ...
    def description(self) -> str:
        return (
            "Food science analysis including food authenticity, quality, and nutritional profiling"
        )
    ...
    def get_available_pipelines(self) -> list[Pipeline]:
        return [
            Pipeline(
                name="authenticity",
                description="Food authenticity analysis",
    ...
    def get_available_analyses(self) -> list[AnalysisDefinition]:
        return [
            ...
            AnalysisDefinition(
                name="nutritional_analysis", description="Nutritional content analysis"
            ),
        ]
