...
class SpeechomicsModule(OmicsModuleBase):
    ...
    def get_available_analyses(self) -> list[AnalysisDefinition]:
        return [
            AnalysisDefinition(
                name="parkinsons_detection", description="Parkinson's speech markers"
            ),
            AnalysisDefinition(
                name="alzheimers_detection", description="Alzheimer's speech markers"
            ),
            AnalysisDefinition(
                name="depression_analysis", description="Depression speech analysis"
            ),
        ]
