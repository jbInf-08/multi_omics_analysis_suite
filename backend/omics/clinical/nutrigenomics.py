...
class NutrigenomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                name="nutrient_gene_analysis",
                description="Nutrient-gene interaction analysis",
                steps=[
                    "load_data",
                    "qc",
                    "snp_annotation",
        ...
        self._analyses = [
            AnalysisDefinition(
                name="nutrient_snps",
                description="Identify nutrition-related SNPs",
                parameters={"nutrients": {"type": "list", "default": None}},
                output_types=["table"],
            ),
            AnalysisDefinition(
                name="diet_response",
                description="Predict dietary response based on genotype",
                parameters={},
                output_types=["table", "recommendation"],
            ),
            AnalysisDefinition(
                name="metabolic_pathways",
                description="Analyze metabolic pathway variants",
                parameters={},
    ...
    def description(self) -> str:
        return "Nutrition-gene interactions and personalized nutrition"
