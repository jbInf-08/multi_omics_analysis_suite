...
class GlycomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                ...
                description="Glycan identification and quantification",
                steps=[
                    "load_data",
                    "qc",
                    "glycan_identification",
                    "quantification",
                    "structural_analysis",
                ],
        ...
        self._analyses = [
            AnalysisDefinition(
                ...
                description="Glycan composition analysis",
                parameters={},
                output_types=["table", "pie_chart"],
            ),
            AnalysisDefinition(
                name="differential_glycans",
                description="Differential glycan analysis",
    ...
    def description(self) -> str:
        return "Glycan structure and protein glycosylation analysis"
    ...
    def normalize(
        self, data: OmicsData, method: str = "sum", params: dict[str, Any] | None = None
    ) -> OmicsData:
