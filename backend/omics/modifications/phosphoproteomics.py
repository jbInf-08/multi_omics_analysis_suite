...
class PhosphoproteomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                name="phosphosite_analysis",
                description="Phosphorylation site quantification and analysis",
                steps=[
                    "load_data",
                    "qc",
                    "normalization",
        ...
        self._analyses = [
            AnalysisDefinition(
                name="differential_phosphosites",
                description="Differential phosphosite analysis",
                parameters={"fdr": {"type": "float", "default": 0.05}},
                output_types=["table", "volcano"],
            ),
            AnalysisDefinition(
                name="kinase_substrate_enrichment",
                description="Kinase-substrate enrichment analysis",
                parameters={"database": {"type": "str", "default": "phosphositeplus"}},
                output_types=["table", "heatmap"],
            ),
            AnalysisDefinition(
                name="motif_analysis",
                description="Phosphorylation motif analysis",
                parameters={"width": {"type": "int", "default": 13}},
                output_types=["motif_logo"],
            ),
        ]
    ...
    def description(self) -> str:
        return "Protein phosphorylation site analysis and kinase activity inference"
