...
class PharmacogenomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                ...
                steps=["load_data", "pgx_variant_calling", "star_allele_calling", "phenotype_prediction", "dosing_recommendation"],
        ...
        self._analyses = [
            AnalysisDefinition(
                ...
                parameters={
                    "genes": {"type": "list", "default": None, "description": "PGx genes to analyze"},
                    "database": {"type": "str", "default": "pharmgkb", "description": "PGx database"},
                },
            ...
            AnalysisDefinition(
                ...
                parameters={
                    "genes": {"type": "list", "default": ["CYP2D6", "CYP2C19"], "description": "Genes for star allele calling"},
                },
    ...
    def _analyze_pgx_variants(self, data: OmicsData, params: AnalysisParams) -> AnalysisResult:
        ...
        pgx_genes = [
            ...
            "SLCO1B1", "TPMT", "DPYD", "UGT1A1", "VKORC1",
            "HLA-A", "HLA-B", "ABCB1", "ABCG2"
        ]
    ...
    def _predict_drug_response(self, data: OmicsData, params: AnalysisParams) -> AnalysisResult:
        ...
        if not recommendations:
            fallback = catalog[:3] if catalog else [
                {
                    "drug": "Clopidogrel",
                    "gene": "CYP2C19",
