...
class LipidomicsModule(OmicsModuleBase):
            ...
            AnalysisDefinition(
                ...
                parameters={
                    "classes": {
                        "type": "list",
                        "default": None,
                        "description": "Lipid classes to analyze",
                    },
                },
            ...
            AnalysisDefinition(
                ...
                parameters={
                    "saturation": {
                        "type": "bool",
                        "default": True,
                        "description": "Analyze saturation",
                    },
                    "chain_length": {
                        "type": "bool",
                        "default": True,
                        "description": "Analyze chain length",
                    },
                },
    ...
    def normalize(
        self, data: OmicsData, method: str = "is", params: dict[str, Any] | None = None
    ) -> OmicsData:
        ...
        if data.sample_metadata is not None and "condition" in data.sample_metadata.columns:
            ...
            if len(conditions) >= 2:
                ...
                for lipid in data.feature_names:
                    if lipid in data.data.columns:
                        v1, v2 = (
                            data.data.loc[g1, lipid].dropna(),
                            data.data.loc[g2, lipid].dropna(),
                        )
