...
class TranscriptomicsModule(OmicsModuleBase):
            ...
            AnalysisDefinition(
                ...
                parameters={
                    "method": {
                        "type": "str",
                        "default": "deseq2",
                        "description": "DE method (deseq2, limma, edger)",
                    },
                    "group_column": {
                        "type": "str",
                        "default": "condition",
            ...
            AnalysisDefinition(
                ...
                parameters={
                    "ranking_metric": {
                        ...
                        "description": "Gene ranking metric",
                    },
                    "database": {
                        "type": "str",
                        "default": "msigdb",
    ...
    def preprocess(
        ...
        processed.feature_names = [
            f for f, k in zip(processed.feature_names, keep_genes, strict=False) if k
        ]
    ...
    def _analyze_differential_expression(
        ...
        if results:
            ...
            de_df["padj"] = (
                false_discovery_control(de_df["pvalue"].values, method="bh")
                if len(de_df) > 0
                else []
            )

            # Classify significance
            de_df["significant"] = (de_df["padj"] < fdr_threshold) & (
    ...
    def visualize(
        ...
        elif result.analysis_type == "pca" and "pca_coordinates" in result.data:
