...
class SecretomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                name="secretome_analysis",
                description="Secretome profiling and analysis",
                steps=[
                    "load_data",
                    "qc",
                    "secretion_prediction",
                    "quantification",
                    "pathway_analysis",
                ],
        ...
        self._analyses = [
            AnalysisDefinition(
                name="secretion_prediction",
                description="Predict secreted proteins",
                parameters={"method": {"type": "str", "default": "signalp"}},
                output_types=["table"],
            ),
            AnalysisDefinition(
                name="differential_secretome",
                description="Differential secreted proteins",
    ...
    def description(self) -> str:
        return "Secreted protein and exosome cargo analysis"
