...
class MembranomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                name="membrane_proteomics",
                description="Membrane protein profiling",
                steps=[
                    "load_data",
                    "qc",
                    "membrane_annotation",
        ...
        self._analyses = [
            AnalysisDefinition(
                ...
                description="Classify membrane proteins",
                parameters={},
                output_types=["table", "pie_chart"],
            ),
            AnalysisDefinition(
                name="topology_analysis",
                description="Membrane topology prediction",
                parameters={"method": {"type": "str", "default": "tmhmm"}},
                output_types=["table"],
            ),
        ]
    ...
    def description(self) -> str:
        return "Membrane proteomics and topology analysis"
