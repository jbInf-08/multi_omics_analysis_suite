...
class DegradomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                name="degradome_analysis",
                description="Protease substrate profiling",
                steps=[
                    "load_data",
                    "qc",
                    "n_terminomics",
                    "cleavage_site_analysis",
                    "protease_prediction",
                ],
        ...
        self._analyses = [
            AnalysisDefinition(
                name="cleavage_sites",
                description="Identify proteolytic cleavage sites",
                parameters={},
                output_types=["table"],
            ),
            AnalysisDefinition(
                name="protease_substrates",
                description="Map protease-substrate relationships",
                parameters={"database": {"type": "str", "default": "merops"}},
    ...
    def description(self) -> str:
        return "Proteolytic processing and protease substrate analysis"
