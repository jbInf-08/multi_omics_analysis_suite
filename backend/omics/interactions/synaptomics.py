...
class SynaptomicsModule(OmicsModuleBase):
    ...
    def __init__(self):
        ...
        self._pipelines = [
            Pipeline(
                ...
                description="Synaptic proteome analysis",
                steps=[
                    "load_data",
                    "qc",
        ...
        self._analyses = [
            AnalysisDefinition(
                name="synaptic_composition",
                description="Synaptic protein composition",
                parameters={},
                output_types=["table", "bar_chart"],
            ),
            AnalysisDefinition(
                name="differential_synaptic",
                description="Differential synaptic proteins",
    ...
    def description(self) -> str:
        return "Synaptic proteomics and connectivity analysis"
