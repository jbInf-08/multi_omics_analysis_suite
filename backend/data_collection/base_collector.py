...
def get_api_key(source_name: str, key_suffix: str = "API_KEY") -> str | None:
...
class CollectorRegistry:
    ...
    @classmethod
    def get(cls, source: DataSource) -> type | None:
    ...
    @classmethod
    def create(
        cls, source: DataSource, config: CollectorConfig | None = None
    ) -> BaseCollector | None:
