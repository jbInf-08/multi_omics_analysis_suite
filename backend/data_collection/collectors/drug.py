        ...
        **kwargs,
        ...
        if not self.has_api_key:
            return self._create_result(
                success=False,
                errors=[
                    "DrugBank API key not configured. Set DRUGBANK_API_KEY environment variable."
                ],
...
class ChEMBLCollector(BaseCollector):
    ...
    async def collect(
        self, chembl_ids: list[str] | None = None, targets: list[str] | None = None, **kwargs
    ) -> CollectionResult:
...
class PharmGKBCollector(BaseCollector):
    ...
    async def collect(
        self, genes: list[str] | None = None, drugs: list[str] | None = None, **kwargs
    ) -> CollectionResult:
...
class GDSCCollector(BaseCollector):
    ...
    async def collect(
        self, drugs: list[str] | None = None, cell_lines: list[str] | None = None, **kwargs
    ) -> CollectionResult:
