        ...
        try:
            if genes:
                for gene in genes[:20]:
                    ...
                    result = await self._get("uniprotkb/search", params={
                        "query": query,
                        "format": "json",
                        "size": 10,
                    })
        ...
        **kwargs
        ...
        try:
            if genes:
                ...
                interactions = await self._get("json/network", params={
                ...
                enrichment = await self._get("json/enrichment", params={
                    "identifiers": identifiers,
                    "species": species,
                })
        ...
        try:
            if genes and self.config.api_key:
                for gene in genes[:10]:
                    result = await self._get("interactions", params={
