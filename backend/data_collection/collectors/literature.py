        ...
        **kwargs,
        ...
        try:
            if query:
                ...
                collected_data["total_count"] = search_result.get("esearchresult", {}).get(
                    "count", 0
                )
...
class EuropePMCCollector(BaseCollector):
    ...
    async def collect(
        self, query: str | None = None, max_results: int = 100, **kwargs
    ) -> CollectionResult:
...
class CBioPortalCollector(BaseCollector):
    ...
    async def collect(
        self, study: str | None = None, genes: list[str] | None = None, **kwargs
    ) -> CollectionResult:
        ...
        try:
            ...
            if genes and study:
                ...
                mutations = await self._get(f"studies/{study}/genes/{genes_str}/mutations")
