...
class BiologicalNetwork:
    ...
    def degree(self, node_id: str) -> int:
        """Get node degree."""
        return len(self._adjacency.get(node_id, set())) + len(
            self._reverse_adjacency.get(node_id, set())
        )
...
class NetworkAnalyzer:
    ...
    def betweenness_centrality(self) -> dict[str, float]:
        ...
        centrality = dict.fromkeys(self.network.nodes, 0.0)
        ...
        while improved:
            ...
            for node in network.nodes:
                ...
                for new_community in neighbor_communities:
                    ...
                    gain = self._modularity_gain(network, communities, node, new_community)
