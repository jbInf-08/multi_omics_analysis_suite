...
class PyMOLController:
    ...
    def _ensure_pymol(self):
        ...
        if self._pymol is None:
            try:
                ...
                raise ImportError("PyMOL not installed. Install with: pip install pymol-open-source")
    ...
    def set_view(
        self,
        zoom_selection: Optional[str] = None,
        orient_selection: Optional[str] = None,
    ):
        """
        Set the view.
    ...
    def create_visualization(
        ...
        # Load structure
        name = self.load_structure(config.pdb_id, config.pdb_file)
