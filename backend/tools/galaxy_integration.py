...
class GalaxyClient:
    ...
    def __init__(self, config: GalaxyConfig | None = None):
    ...
    async def import_workflow(
        ...
        data = await self._request("POST", "workflows", data={"workflow": workflow_dict})
    ...
    async def get_invocation_status(
        ...
        return await self._request("GET", f"workflows/{workflow_id}/invocations/{invocation_id}")
