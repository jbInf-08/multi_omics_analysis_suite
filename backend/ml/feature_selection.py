...
class FeatureSelector:
    ...
    def variance_filter(
        ...
        selected_features = [f for f, s in zip(feature_names, selected_mask, strict=False) if s]

        variances = np.var(X_arr, axis=0)
        feature_scores = dict(zip(feature_names, variances, strict=False))
    ...
    def univariate_selection(
        ...
        feature_scores = dict(zip(feature_names, selector.scores_, strict=False))
    ...
    def rfe_selection(
        ...
        feature_scores = dict(zip(feature_names, 1 / selector.ranking_, strict=False))
    ...
    def embedded_selection(
        ...
        feature_scores = dict(zip(feature_names, importances, strict=False))
    ...
    def stability_selection(
        ...
        feature_scores = dict(zip(feature_names, selection_freq, strict=False))
