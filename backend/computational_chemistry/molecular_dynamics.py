...
class VelocityVerletIntegrator(Integrator):
    ...
    def step(
        ...
        new_forces, energy = force_field.calculate_forces(new_positions, molecule, state.box)
...
class MDSimulation:
    ...
    def run(
        ...
        for step in range(n_steps):
            # Integration step
            self.state = self.integrator.step(self.state, self.molecule, self.force_field)
