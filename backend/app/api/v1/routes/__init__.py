...
from backend.app.api.v1.routes.biomarkers import router as biomarkers_router
...
api_router.include_router(biomarkers_router, prefix="/biomarkers", tags=["Biomarker Discovery"])
