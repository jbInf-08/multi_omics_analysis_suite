...
async def list_pipelines(
    ...
    count_query = select(func.count(Pipeline.id)).where(Pipeline.is_active == True)
    
    if public_only:
        query = query.where(Pipeline.is_public == True)
        count_query = count_query.where(Pipeline.is_public == True)
