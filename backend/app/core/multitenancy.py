...
class TenantManager:
    ...
    TIER_QUOTAS = {
        TenantTier.FREE: TenantQuotas(
            max_users=3, max_projects=5, max_datasets=20,
            max_storage_gb=5, max_analyses_per_day=50,
            max_concurrent_jobs=1, api_rate_limit=500
        ),
        TenantTier.BASIC: TenantQuotas(
            max_users=10, max_projects=25, max_datasets=100,
            max_storage_gb=50, max_analyses_per_day=200,
            max_concurrent_jobs=3, api_rate_limit=2000
        ),
        TenantTier.PROFESSIONAL: TenantQuotas(
            max_users=50, max_projects=100, max_datasets=500,
            max_storage_gb=500, max_analyses_per_day=1000,
            max_concurrent_jobs=10, api_rate_limit=10000
        ),
        TenantTier.ENTERPRISE: TenantQuotas(
            max_users=999999, max_projects=999999, max_datasets=999999,
            max_storage_gb=10000, max_analyses_per_day=999999,
            max_concurrent_jobs=100, api_rate_limit=999999
        ),
    }
    
    TIER_FEATURES = {
        TenantTier.FREE: [
            "basic_analysis", "data_upload", "visualization"
        ],
        TenantTier.BASIC: [
            "basic_analysis", "data_upload", "visualization",
            "pathway_analysis", "export", "api_access"
        ],
        TenantTier.PROFESSIONAL: [
            "basic_analysis", "data_upload", "visualization",
            "pathway_analysis", "export", "api_access",
            "ml_models", "survival_analysis", "biomarker_discovery",
            "custom_workflows", "collaboration"
        ],
        TenantTier.ENTERPRISE: [
            ...
            "ml_models", "survival_analysis", "biomarker_discovery",
            "custom_workflows", "collaboration",
            "ai_features", "custom_branding", "sso", "audit_logs",
            "dedicated_support", "on_premise"
        ],
    }
    ...
    def delete_tenant(self, tenant_id: str) -> bool:
        ...
        self._tenant_context = {
            k: v for k, v in self._tenant_context.items() if v != tenant_id
        }
