...
class OAuth2Config:
    ...
    audience: Optional[str] = None  # Auth0 API audience
...
class OAuth2Client:
    ...
    async def logout_url(self, return_to: Optional[str] = None) -> Optional[str]:
        """
...
class Auth0Client(OAuth2Client):
    ...
    def __init__(self, config: OAuth2Config, management_token: Optional[str] = None):
        """
