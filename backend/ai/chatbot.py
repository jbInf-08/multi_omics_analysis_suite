...
from backend.ai.llm_providers import LLMProvider, LLMConfig, get_provider
...
Always prioritize scientific accuracy and reproducibility."""
    ...
    async def ask_about_analysis(
        ...
        if question:
            ...
            message = f"Please interpret these {analysis_type} results and highlight the key findings."
...
4. Practical considerations"""
    ...
    def _format_context(self, context: Dict[str, Any]) -> str:
        ...
        if "data_info" in context:
            ...
            parts.append(f"- Data: {info.get('n_samples', 'N/A')} samples, {info.get('n_features', 'N/A')} features")
